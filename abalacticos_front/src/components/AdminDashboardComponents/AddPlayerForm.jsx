...
const PlayerForm = ({ onPlayerAdded }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        // Flatten the appearances object
        const dataToSend = {
            ...playerData,
            tuesdayAppearances: playerData.tuesdayAppearances,
            wednesdayAppearances: playerData.wednesdayAppearances,
            fridayAppearances: playerData.fridayAppearances
        };

        try {
            const response = await axios.post('http://localhost:8080/api/users/registerAdmin', dataToSend, {
                headers: {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="surname" value={playerData.surname} onChange={handleChange} placeholder="Surname"
                   required/>
            <input type="date" name="debutDate" value={playerData.debutDate} onChange={handleChange}
                   placeholder="Debut Date" required/>
            <input type="date" name="lastGK" value={playerData.lastGK} onChange={handleChange}
                   placeholder="Last Game Date"/>
            ...
            <input type="text" name="invitationFriend" value={playerData.invitationFriend} onChange={handleChange}
                   placeholder="Invitation Friend"/>
            <input type="text" name="favClub" value={playerData.favClub} onChange={handleChange}
                   placeholder="Favorite Club"/>
            <input type="text" name="sn" value={playerData.sn} onChange={handleChange} placeholder="Serial Number"/>
            <input type="date" name="birthday" value={playerData.birthday} onChange={handleChange}
                   placeholder="Birthday"/>
            <input type="number" name="tuesdayAppearances" value={playerData.tuesdayAppearances}
                   onChange={handleChange} placeholder="Tuesday"/>
