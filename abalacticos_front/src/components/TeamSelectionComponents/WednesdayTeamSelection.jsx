...
const WednesdayTeamSelection = () => {
    ...
    const wednesdayPlayers = players.filter(player => player.availability.includes('Wednesday'));
    ...
    return (
        <div>
            ...
            <div style={{ height: 400, width: '100%' }}>
                <DataGrid rows={wednesdayPlayers} columns={columns} />
            </div>
        </div>
    );
};

export default WednesdayTeamSelection;
