...
const FridayTeamSelection = () => {
    ...
    const FridayPlayers = players.filter(player => player.availability.includes('Friday'));
    ...
    return (
        <div>
            ...
            <div style={{ height: 400, width: '100%' }}>
                <DataGrid rows={FridayPlayers} columns={columns} />
            </div>
        </div>
    );
};

export default FridayTeamSelection;
